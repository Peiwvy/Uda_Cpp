...
class Student {
    ...
    public:     
         // public constructor for Student method1
        // Student(std::string n, int y, double g){
        //     name = n;
        //     year = y;
        //     gpa = g;
        // }
        // public constructor for Student method2
        Student(std::string n, int y, double g):name(n), year(y), gpa(g) {}
...
int main(){
    ...
    std::cout << "Student Grade : " << student.GetYear() << "\n";
