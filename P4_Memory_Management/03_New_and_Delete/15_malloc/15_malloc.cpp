...
Its function is to allocate a block of specific size, measured in bytes of memory, where result of 
this operation (function) is pointer to the beginning of the block. Data stored in this memory block 
is not initialized, which means that this space has non determinate values. 
*/
